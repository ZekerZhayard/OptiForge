...
public class ItemRendererTransformer implements ITransformer<ClassNode>, ITransformerImpl {
    ...
    public ClassNode transform(ClassNode input) {
        ...
        // https://github.com/MinecraftForge/MinecraftForge/blob/1.15.x/patches/minecraft/net/minecraft/client/renderer/entity/ItemRenderer.java.patch#L13-L15
        //
        ...
        for (AbstractInsnNode ain : render.instructions.toArray()) {
            if (ain.getOpcode() == Opcodes.FSTORE) {
                ...
                if (vin.var == f6.index) {
                    ...
                    } while (!(ain0.getOpcode() == Opcodes.INVOKEVIRTUAL && ((min = (MethodInsnNode) ain0).owner.equals("com/mojang/blaze3d/matrix/MatrixStack")) && min.name.equals(ASMAPI.mapMethod("func_227863_a_")) && min.desc.equals("(Lnet/minecraft/client/renderer/Quaternion;)V")));
                }
            } else if (ain.getOpcode() == Opcodes.FLOAD) {

                // https://github.com/MinecraftForge/MinecraftForge/blob/1.15.x/patches/minecraft/net/minecraft/client/renderer/entity/ItemRenderer.java.patch#L17-L22
                //
                //        if (!flag) {
                ...
                //        }
                //
                // https://github.com/MinecraftForge/MinecraftForge/blob/1.15.x/patches/minecraft/net/minecraft/client/renderer/entity/ItemRenderer.java.patch#L43-L44
                //
                //           if (!flag) {
                ...
                if (vin.var == f4.index || vin.var == f5.index || vin.var == f6.index) {
                    ...
                    // (fconst_0 -> dconst_0) / (ldc Float 0.09375 -> ldc Double 0.09375)
                    ...
                    render.instructions.remove(ainN);
