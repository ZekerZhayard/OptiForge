...
public class EntityDataManagerTransformer implements ITransformer<ClassNode>, ITransformerImpl {
    ...
    public ClassNode transform(ClassNode input) {
        // https://github.com/MinecraftForge/MinecraftForge/blob/1.16.x/patches/minecraft/net/minecraft/network/datasync/EntityDataManager.java.patch#L7-L8
        //
            ...
            if (ain.getOpcode() == Opcodes.GETSTATIC) {
                ...
                if (fin.owner.equals("net/minecraft/network/datasync/EntityDataManager") && fin.name.equals(ASMAPI.mapField("field_190303_a")) && fin.desc.equals("Lorg/apache/logging/log4j/Logger;")) {
                    ...
                    if (loggerCount == 1) {
                        ...
                        // https://github.com/MinecraftForge/MinecraftForge/blob/1.16.x/patches/minecraft/net/minecraft/network/datasync/EntityDataManager.java.patch#L12-L15
                        //
