            ...
            if (ain instanceof LabelNode) {
                ...
                if (fin.owner.equals("net/minecraft/client/renderer/entity/model/EntityModel") && fin.name.equals(ASMAPI.mapField("field_217113_d")) && fin.desc.equals("Z")) {
                    if (fin.getOpcode() == Opcodes.PUTFIELD) {
                        ...
                        // https://github.com/MinecraftForge/MinecraftForge/blob/1.16.x/patches/minecraft/net/minecraft/client/renderer/entity/LivingRenderer.java.patch#L18-L19
                        //
                        //        float f2 = f1 - f;
                ...
                // https://github.com/MinecraftForge/MinecraftForge/blob/1.16.x/patches/minecraft/net/minecraft/client/renderer/entity/LivingRenderer.java.patch#L27-L28
                //
                //        float f5 = 0.0F;
