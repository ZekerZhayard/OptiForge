...
public class OptiForgeWrapperTransformer<T> implements ITransformer<ClassNode> {
    protected ITransformer<T> wrappedTransformer;
    protected Target target;

    public OptiForgeWrapperTransformer(ITransformer<T> wrappedTransformer, Target target) {
